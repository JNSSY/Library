...
//        mAppBarLayout.addOnOffsetChangedListener(this);
   ...
   /* private void initView() {
    ...
    public void onClick(View view) {
        ...
        } else if (i == R.id.ll_pay) {
            Toast.makeText(this, "付钱", Toast.LENGTH_SHORT).show();
        } else if (i == R.id.ll_shouqian) {
            Toast.makeText(this, "收钱", Toast.LENGTH_SHORT).show();
        } else if (i == R.id.ll_kabao) {
            Toast.makeText(this, "卡包", Toast.LENGTH_SHORT).show();
        } else if (i == R.id.close_scan_iv) {
            Toast.makeText(this, "扫一扫", Toast.LENGTH_SHORT).show();
        } else if (i == R.id.close_pay_iv) {
            Toast.makeText(this, "付钱", Toast.LENGTH_SHORT).show();
        } else if (i == R.id.close_charge_iv) {
            Toast.makeText(this, "收钱", Toast.LENGTH_SHORT).show();
        } else if (i == R.id.close_card_iv) {
            Toast.makeText(this, "卡包", Toast.LENGTH_SHORT).show();
        }
    }
