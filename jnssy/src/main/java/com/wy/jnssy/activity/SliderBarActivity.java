...
import com.wy.jnssy.adapter.UserAdapter;
import com.wy.jnssy.view.HintSideBar;
import com.wy.jnssy.view.SideBar;
import com.wy.jnssy.view.User;
...
public class SliderBarActivity extends AppCompatActivity implements SideBar.OnChooseLetterChangedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        RecyclerView rv_userList =  findViewById(R.id.rv_userList);
